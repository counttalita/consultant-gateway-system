 ...
 * 
 * Displays validation error or success messages for form fields
 * 
 ...
 */
const ValidationMessage = ({ type = 'error', message, className, id }) => {
  if (!message) return null;

  const baseClasses = 'text-sm mt-1 flex items-start';
